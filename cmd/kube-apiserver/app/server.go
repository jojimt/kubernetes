...
func postProcessOpenAPISpecForBackwardCompatibility(s *spec.Swagger) (*spec.Swagger, error) {
	compatibilityMap := map[string]string{
		...
		"v1beta1.NetworkList":                 "k8s.io/kubernetes/pkg/apis/extensions/v1beta1.NetworkList",
		...
		"v1beta1.NetworkSpec":                         "k8s.io/kubernetes/pkg/apis/extensions/v1beta1.NetworkSpec",
		...
		"v1beta1.Network":                             "k8s.io/kubernetes/pkg/apis/extensions/v1beta1.Network",
